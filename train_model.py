...
def define_model(
    ...
    me = SpatialTemporalDropout1D(feature_rate=DROPOUT_RATE, timestep_rate=DROPOUT_RATE, name='dropout1')(me)
    ...
    att1 = SpatialTemporalDropout1D(feature_rate=DROPOUT_RATE, timestep_rate=DROPOUT_RATE, name='dropout2')(att1)
